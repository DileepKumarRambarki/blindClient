...
} from "./chunk-LWRG4FJM.js";
import {
  capitalize_default
} from "./chunk-S3WJK46N.js";
import {
...
function FocusTrap(props) {
  ...
  return (0, import_jsx_runtime3.jsxs)(React16.Fragment, {
    ...
    }), React16.cloneElement(children2, {
      ref: handleRef,
      onFocus
...
var Portal = React17.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React17.isValidElement(children2) ? children2.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React17.isValidElement(children2)) {
      const newProps = {
        ref: handleRef
      };
      return React17.cloneElement(children2, newProps);
    }
...
var RtlContext = React30.createContext();
...
function createGrid(options = {}) {
  ...
  const GridOverflowContext = React36.createContext(void 0);
  if (true) {
  ...
  const Grid2 = React36.forwardRef(function Grid3(inProps, ref) {
    ...
    const overflow2 = React36.useContext(GridOverflowContext);
    const {
      className,
      children: children2,
    ...
    let result = (0, import_jsx_runtime14.jsx)(GridRoot, _extends({
      ...
      children: React36.Children.map(children2, (child) => {
        if (React36.isValidElement(child) && isMuiElement(child, ["Grid"])) {
...
var Paper = React42.forwardRef(function Paper2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiPaper"
  });
